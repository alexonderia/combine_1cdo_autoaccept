...
- Изменения из frontend не проходят через докер, из-за этого некоторые правки ( например, удаление лишних вариантов в листбоксе "Сервисы", вкладка "Тестирование") не отображаются при запуске сайта на данный момент
